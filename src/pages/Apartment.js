...
import "../responsive/Apartment-mobile.css";
    ...
    <div className="container">
      ...
      <div className="infos_principales">
        ...
        <div className="user">
          <div className="user_infos">
            <h3> {found.host.name} </h3>
            <img src={found.host.picture} alt="host" />
          </div>
          <div className="rateContainer">
            {found.rating >= 1 ? (
              <img src={SvgRed} alt="rate" />
            ) : (
              <img src={Svg} alt="rate" />
            )}
            {found.rating >= 2 ? (
              <img src={SvgRed} alt="rate" />
            ) : (
      ...
      <div className="description">
        ...
        <Collapse label="Équipements">
          <ul>
            {" "}
            {found?.equipments.map((equipment, index) => (
